...
export function extractRetryNumFromHTTPRequest(req: IncomingMessage): number | undefined {
  let retryNum;
...
export function extractRetryReasonFromHTTPRequest(req: IncomingMessage): string | undefined {
  let retryReason;
